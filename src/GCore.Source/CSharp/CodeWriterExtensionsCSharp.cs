...
namespace GCore.Source.CSharp
{
    public static class CodeWriterExtensionsCSharp
    {
        ...
        public static CodeWriter WriteLineNumberDirective(this CodeWriter writer, SourceSpan span) {
            ...
            return writer.Write("#line ").Write(lineNumberAsString).Write(" \"").Write(span.FilePath ?? "<null>").WriteLine("\"");
        }
