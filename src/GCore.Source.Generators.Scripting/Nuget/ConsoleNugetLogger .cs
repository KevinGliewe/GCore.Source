...
namespace GCore.Source.Generators.Scripting.Nuget
{
    public class ConsoleNugetLogger : ILogger
    {
        ...
        public void LogMinimal(string data) => GCore.Logging.Log.Debug(Truncate(data));

        public void LogWarning(string data) =>
            GCore.Logging.Log.Warn(Truncate(data));

        public void LogError(string data) =>
            GCore.Logging.Log.Warn(data);

        public void LogInformationSummary(string data) =>
            GCore.Logging.Log.Info(Truncate(data));
